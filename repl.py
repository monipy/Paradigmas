...
def esiterable(objeto):
    """Retorna True si el objeto es un iterador pero noayuda es una cadena."""
...
class Completador:
    ...
    def completar(self, texto, estado):
        ...
        if estado == 0:
            if texto:
                self.o = [o for o in self.opciones if o and o.startswith(texto)]
            else:
...
def main():
    ...
    comandos = {"eval": eval, "hola": hola, "quit": quit}
